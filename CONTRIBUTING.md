...
[**Stylelint Conqueror Config SCSS Code of Conduct**](https://github.com/Conqueror-Site-Builder/stylelint-conqueror-config-scss/blob/main/CODE_OF_CONDUCT.md).
By participating, you are expected to uphold this code.

## I Have a Question

> If you want to ask a question, we assume that you have read
> the available [**Documentation**](https://github.com/Conqueror-Site-Builder/stylelint-conqueror-config-scss/blob/main/README.md).

Before you ask a question, it is best to search for existing
[**Issues**](https://github.com/Conqueror-Site-Builder/stylelint-conqueror-config-scss/issues)
...
-   Open an
    [**Issue**](https://github.com/Conqueror-Site-Builder/stylelint-conqueror-config-scss/issues/new/choose).
...
-   Determine if your bug is really a bug and not an error on your side e.g.
    ...
    (Make sure that you have read the [**Documentation**](https://github.com/Conqueror-Site-Builder/stylelint-conqueror-config-scss/blob/main/README.md).
...
-   To see if other users have experienced (and potentially already solved)
    ...
    [**bug tracker**](https://github.com/Conqueror-Site-Builder/stylelint-conqueror-config-scss/issues?q=label%3Abug).
...
**Stylelint Conqueror Config SCSS**, **including completely new features
...
-   Read the [**Documentation**](https://github.com/Conqueror-Site-Builder/stylelint-conqueror-config-scss/blob/main/README.md)
    carefully and find out if the functionality is already covered,
    maybe by an individual configuration.

-   Perform a
    [**search**](https://github.com/Conqueror-Site-Builder/stylelint-conqueror-config-scss/issues)
...
Enhancement suggestions are tracked as [**GitHub Issues**](https://github.com/Conqueror-Site-Builder/stylelint-conqueror-config-scss/issues/new/choose).
...
-   **Explain why this enhancement would be useful** to most
    **Stylelint Conqueror Config SCSS** users. You may also want to point
    out the other projects that solved it better and which
    could serve as inspiration.

### Improving The Documentation

Enhancing the documentation of **Stylelint Conqueror Config SCSS** is
...
-   **Explain why this enhancement would be useful** to most
    **Stylelint Conqueror Config SCSS** users.
