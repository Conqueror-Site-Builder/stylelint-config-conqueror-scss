...
const propertiesOrder = {
  'order/order': [
    ...
    await createRule({ selector: selectors.nested.NESTED_ATTRIBUTE_REGEX }),
    await createRule({ selector: selectors.nested.ATTRIBUTE_REGEX }),
    await createRule({ selector: selectors.nested.NESTED_ATTRIBUTE_SIBLING_REGEX }),
    await createRule({ selector: selectors.nested.NESTED_ATTRIBUTE_CHILD_REGEX }),
    await createRule({ selector: selectors.child.ATTRIBUTE_SIBLING_REGEX }),
    await createRule({ selector: selectors.child.ATTRIBUTE_CHILD_REGEX }),
    await createRule({ selector: selectors.nested.NESTED_CLASS_REGEX }),
    await createRule({ selector: selectors.nested.CLASS_REGEX }),
    await createRule({ selector: selectors.nested.NESTED_CLASS_SIBLING_REGEX }),
    await createRule({ selector: selectors.nested.NESTED_CLASS_CHILD_REGEX }),
    await createRule({ selector: selectors.child.CLASS_SIBLING_REGEX }),
    await createRule({ selector: selectors.child.CLASS_CHILD_REGEX }),
    await createRule({ selector: selectors.child.SIBLING_REGEX }),
    await createRule({ selector: selectors.child.CHILD_REGEX }),
  ...
  'order/properties-order': [
    [
      await createPropertiesGroup({ groupName: 'All', properties: ['all', 'page'] }),
