...
const propertiesOrder = {
  'order/order': [
    ...
    createRule('&::part'),
    createRule('&::slotted'),
    createRule(experimental.pseudoElement.targetText),
    createRule(experimental.pseudoElement.spellingError),
    createRule(experimental.pseudoElement.grammarError),
    createRule(experimental.pseudoElement.viewTransition),
    createRule(experimental.pseudoElement.view.transition.group),
    createRule(experimental.pseudoElement.view.transition.imagePair),
    createRule(experimental.pseudoElement.view.transition.new),
    createRule(experimental.pseudoElement.view.transition.old),
    createRule(experimental.pseudoElement.webkit.slider.runnableTrack),
    createRule(experimental.pseudoElement.webkit.slider.thumb),
    createRule(experimental.pseudoElement.moz.focusInner),
    createRule(nonStandard.pseudoElement.webkit.innerSpinButton),
    createRule(nonStandard.pseudoElement.webkit.meterBar),
    createRule(nonStandard.pseudoElement.webkit.meterEvenLessGoodValue),
    createRule(nonStandard.pseudoElement.webkit.meterInnerElement),
    createRule(nonStandard.pseudoElement.webkit.meterOptimumValue),
    createRule(nonStandard.pseudoElement.webkit.meterSubOptimumValue),
    createRule(nonStandard.pseudoElement.webkit.progressBar),
    createRule(nonStandard.pseudoElement.webkit.progressInnerElement),
    createRule(nonStandard.pseudoElement.webkit.progressValue),
    createRule(nonStandard.pseudoElement.webkit.scrollbar),
    createRule(nonStandard.pseudoElement.webkit.searchResultsButton),
    createRule(nonStandard.pseudoElement.webkit.searchCancelButton),
    createRule(nonStandard.pseudoElement.moz.colorSwatch),
    createRule(nonStandard.pseudoElement.moz.listBullet),
    createRule(nonStandard.pseudoElement.moz.listNumber),
    createRule(nonStandard.pseudoElement.moz.page),
    createRule(nonStandard.pseudoElement.moz.pageSequence),
    createRule(nonStandard.pseudoElement.moz.pageSequence),
    createRule(nonStandard.pseudoElement.moz.progressBar),
    createRule(nonStandard.pseudoElement.moz.rangeTrack),
    createRule(nonStandard.pseudoElement.moz.rangeProgress),
    createRule(nonStandard.pseudoElement.moz.rangeThumb),
    createRule(nonStandard.pseudoElement.moz.scrolledPageSequence),
    createRule('&:root'),
    createRule('&:lang'),
    createRule('&:scope'),
    createRule('&:modal'),
    ...
    createRule(experimental.pseudoClass.targetWithin),
    createRule(experimental.pseudoClass.blank),
    createRule('&:default'),
    createRule('&:enabled'),
    createRule('&:disabled'),
    createRule('&:hover'),
    ...
    createRule('&:seeking'),
    createRule(nonStandard.pseudoClass.moz.broken),
    createRule(nonStandard.pseudoClass.moz.dragOver),
    createRule(nonStandard.pseudoClass.moz.firstNode),
    createRule(nonStandard.pseudoClass.moz.lastNode),
    createRule(nonStandard.pseudoClass.moz.handlerBlocked),
    createRule(nonStandard.pseudoClass.moz.handlerCrashed),
    createRule(nonStandard.pseudoClass.moz.handlerDisabled),
    createRule(nonStandard.pseudoClass.moz.loading),
    createRule(nonStandard.pseudoClass.moz.localeDir),
    createRule(nonStandard.pseudoClass.moz.onlyWhitespace),
    createRule(nonStandard.pseudoClass.moz.submitInvalid),
    createRule(nonStandard.pseudoClass.moz.suppressed),
    createRule(nonStandard.pseudoClass.moz.userDisabled),
    createRule(nonStandard.pseudoClass.moz.windowInactive),
